...
class CashierLiveshow extends Component
{
    ...
    {
        $existingCart = Keranjang::on('cashier')->where('user_id', auth()->user()->user_id)
    ...
    public function getFilterName($filterType, $filterId)
    {
        ...
        switch ($filterType) {
            ...
            case 'category':
                $filter = Kategori::on('cashier')->find($filterId);
                break;
        }
    ...
    public function render()
    {
        ...
        $this->categories = Kategori::on('cashier')->orderBy('category')->get();
