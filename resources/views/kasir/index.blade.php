...
<head>
    ...
    <style>
        ...
        /* Pastikan livewire:cashier-liveshow berada di bawah */
        .livewire-cashier-liveshow {
            position: relative;
            z-index: 10;  /* Lebih rendah */
        }

        /* Pastikan livewire:cartdisplay berada di atas */
        .livewire-cartdisplay {
            position: relative;
            z-index: 20;  /* Lebih tinggi */
        }
        /* Menempatkan cartdisplay dengan fixed dan memberi ruang */
        .cartdisplay {
            position: absolute;
            right: 0;
            top: 0;
            width: 33%;
            height: 100vh;
            z-index: 20;  /* Memastikan berada di atas */
        }
...
<body class="font-Inter relative">
    ...
    // Menambahkan event listener saat livewire:load
    document.addEventListener('livewire:load', function () {
        const cartButton = document.querySelector('button[onclick="toggleCartDisplay()"]');
        if (cartButton) {
            cartButton.addEventListener('click', toggleCartDisplay);
        }
    });
