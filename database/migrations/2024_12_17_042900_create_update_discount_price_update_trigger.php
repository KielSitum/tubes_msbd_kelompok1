...
return new class extends Migration
{
    ...
    {
        $sql = "
        DROP TRIGGER IF EXISTS update_discount_price_update;

        CREATE TRIGGER update_discount_price_update
        AFTER UPDATE ON promo_diskon
        FOR EACH ROW
        BEGIN
            ...
            ELSE
                ...
                UPDATE invoice_selling_details
                JOIN produk ON invoice_selling_details.product_name = produk.product_name
                SET invoice_selling_details.discounted_price = NULL
                WHERE produk.product_status = 'aktif';
            END IF;
        END;
