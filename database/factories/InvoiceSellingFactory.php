...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\InvoiceSelling>
 */
class InvoiceSellingFactory extends Factory
{
    /**
    ...
    {
        $produk_id = InvoiceSelling::orderBy('invoice_code', 'desc')->pluck('invoice_code')->first();
        ...
        return [
            ...
            'cashier_name' => Kasir::first()->user->username,
